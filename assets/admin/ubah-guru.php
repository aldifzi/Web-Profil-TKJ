...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['update'])) {
		...
		if (!empty($filename)) {
			...
			$result = mysqli_query($connection, "UPDATE tguru SET nip='$nip',nama='$nama',pendidikan='$pendidikan',mata_pelajaran='$mata_pelajaran',kelamin='$kelamin',hp='$hp',tangal_lahir='$tangal_lahir',tempat_lahir='$tempat_lahir',alamat='$alamat',gambar='$filename' WHERE id=$id");
		}

		// MEMASUKAN DATA YANG DI UPDATE KECUALI GAMBAR
		$result = mysqli_query($connection, "UPDATE tguru SET nip='$nip',nama='$nama',pendidikan='$pendidikan',mata_pelajaran='$mata_pelajaran',kelamin='$kelamin',hp='$hp',tangal_lahir='$tangal_lahir',tempat_lahir='$tempat_lahir',alamat='$alamat' WHERE id=$id");
...
?>
	...
	$result = mysqli_query($connection, "SELECT * FROM tguru WHERE id=$id");
												...
												<div class="row">
													<div class="col">
														<div class="form-group">
															...
															<br>
															<img style="margin-bottom: 10px;" width="80" src="images/<?php echo $image ?>">
