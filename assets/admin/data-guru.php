						    ...
						    <tbody>
						        <?php while($row = mysqli_fetch_assoc($query)) : ?>
									<tr>
										...
										<td><?= $row['alamat'] ?></td>
										<td>
											<a href="ubah-guru?id=<?= $row['id'] ?>" class="btn btn-success btn-sm">Ubah</a>
											<a href="hapus-guru?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('apakah anda yakin?')">Hapus</a>
										</td>
									</tr>
								<?php endwhile; ?>
						    </tbody>
