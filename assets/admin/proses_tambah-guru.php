...
$hp = mysqli_escape_string($connection, $_POST['hp']);
$tempat_lahir = mysqli_escape_string($connection, $_POST['tempat_lahir']);
$tanggal_lahir = mysqli_escape_string($connection, $_POST['tangal_lahir']);
...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		...
		$query = mysqli_query($connection, "INSERT INTO tguru (nama, nip, jenis_kelamin, hp, tempat_lahir, tangal_lahir, mata_pelajaran, alamat, foto) VALUES('$nama', $nip, '$jenis_kelamin', '$hp', '$tempat_lahir', '$tanggal_lahir', '$mata_pelajaran', '$alamat', '$nama_foto')") or die(mysqli_error($connection));
