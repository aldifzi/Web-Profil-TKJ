...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['Submit'])) {
		...
		$result = mysqli_query($connection, "INSERT INTO tguru(nip,nama,pendidikan,mata_pelajaran,kelamin,hp,tangal_lahir,tempat_lahir,alamat,gambar) VALUES('$nip','$nama', '$pendidikan','$mata_pelajaran','$kelamin', '$hp','$tangal_lahir','$tempat_lahir','$alamat', '$filename')");
